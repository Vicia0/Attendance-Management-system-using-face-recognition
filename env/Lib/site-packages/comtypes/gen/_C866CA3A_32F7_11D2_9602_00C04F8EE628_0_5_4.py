...
__all__ = [
    'WAVEFORMATEX', 'SAFTCCITT_ALaw_11kHzStereo', 'SRAImport',
    'DISPID_SOTCDefault', 'DISPID_SLPPartOfSpeech',
    'DISPID_SPIEnginePrivateData', 'SpeechInterference', 'SGLexical',
    'eLEXTYPE_RESERVED8', 'SpeechRegistryLocalMachineRoot',
    'ISpeechObjectToken', 'SPRST_INACTIVE_WITH_PURGE',
    'SPFM_NUM_MODES', 'SPEI_WORD_BOUNDARY', 'SPPS_RESERVED4',
    'SPPS_SuppressWord', 'DISPID_SPARecoResult', 'SPPS_NotOverriden',
    'DISPID_SPRulesCount', 'DISPID_SPRuleId', 'SVSFParseSapi',
    'SRCS_Disabled', 'DISPID_SGRSTPropertyName', 'SpeechWordType',
    'eLEXTYPE_APP', 'ISpeechPhraseReplacement', 'SVSFIsNotXML',
    'DISPID_SOTGetStorageFileName', 'eLEXTYPE_PRIVATE2',
    'DISPID_SOTsItem', 'DISPID_SPEAudioStreamOffset', 'SVP_5',
    'SPSHORTCUTTYPE', 'DISPID_SLWsCount', 'ISpeechPhraseRule',
    'SVP_15', 'SPCONTEXTSTATE', 'SASClosed',
    'SAFTExtendedAudioFormat', 'DISPID_SpeechAudioBufferInfo',
    'SPVOICESTATUS', 'SPRULE', 'SVSFDefault', 'SPINTERFERENCE_NOISE',
    'DISPID_SpeechLexiconProns', 'DISPID_SVSkip', 'SVP_7',
    'eLEXTYPE_USER', 'DISPID_SASState', 'DISPID_SRRTTickCount',
    'SPRECORESULTTIMES', 'SpeechTokenValueCLSID', 'SRAExport',
    'DISPID_SpeechAudioFormat', 'SPSEMANTICFORMAT',
    'DISPID_SRCEInterference', 'DISPID_SOTCEnumerateTokens',
    'SRSActiveAlways', 'eLEXTYPE_PRIVATE11',
    'DISPID_SpeechRecognizerStatus', 'SREPhraseStart',
    'SRESoundStart', 'DISPID_SVSInputWordPosition',
    'DISPID_SRCRetainedAudioFormat', 'SpeechGrammarWordType',
    'SP_VISEME_15', 'SPEI_VOICE_CHANGE', 'SDTProperty',
    'eLEXTYPE_PRIVATE12', 'DISPID_SPEsCount', 'ISpeechLexiconWords',
    'DISPID_SPIReplacements', 'SVEBookmark', 'SpeechVoiceSpeakFlags',
    'SSFMCreate', 'ISequentialStream', 'Speech_Default_Weight',
    'DISPID_SLWsItem', 'SpStreamFormatConverter',
    'DISPID_SDKGetStringValue', 'SVP_17',
    'SSSPTRelativeToCurrentPosition', 'STCLocalServer',
    'DISPID_SVEBookmark', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SPIStartTime', 'DISPID_SVPriority', 'SPEI_RESERVED2',
    'SpeechBookmarkOptions', 'DISPID_SPPEngineConfidence',
    'SVSFParseAutodetect', 'DISPID_SPEDisplayAttributes',
    'SPEI_SOUND_START', 'SP_VISEME_7', 'DISPID_SpeechAudio',
    'SpeechCategoryPhoneConverters', 'SVEWordBoundary',
    'DISPID_SGRSRule', 'DISPID_SLPSymbolic', 'SpObjectTokenCategory',
    'DISPID_SRCPause', 'DISPID_SRCCreateGrammar',
    'SPEI_START_SR_STREAM', 'ISpProperties', 'UINT_PTR',
    'SpeechPropertyResponseSpeed', 'DISPID_SLWType',
    'IEnumSpObjectTokens', 'SPSERIALIZEDPHRASE',
    'DISPID_SRGCmdLoadFromMemory', 'SPRECOSTATE', 'ISpVoice',
    'SP_VISEME_4', 'DISPID_SpeechGrammarRuleStateTransition',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SOTCategory',
    'ISpGrammarBuilder', 'SDTDisplayText', 'DISPID_SPAs_NewEnum',
    'DISPID_SPIAudioSizeTime', 'DISPID_SWFEChannels',
    'DISPID_SPIElements', 'SPEI_ADAPTATION', 'SP_VISEME_14',
    'SRSInactive', 'DISPID_SRGSetTextSelection', 'SREStateChange',
    'SpeechVisemeType', 'ISpPhoneticAlphabetConverter', 'SPBO_PAUSE',
    'DISPID_SRRecognizer', 'SITooSlow',
    'SpeechStreamSeekPositionType', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPGS_DISABLED', 'DISPID_SGRClear', 'DISPID_SpeechFileStream',
    'DISPID_SRSetPropertyString', 'SVP_12', 'SPPHRASEREPLACEMENT',
    'SGDSActiveWithAutoPause', 'ISpeechBaseStream',
    ...
    'SPSMF_UPS', 'SpeechCategoryAudioIn', 'SREAllEvents',
    'DISPID_SpeechLexiconPronunciation', 'SPWORDPRONOUNCEABLE',
    'Speech_StreamPos_Asap', 'DISPID_SLWLangId',
    'DISPID_SPEPronunciation', 'SpeechTokenKeyFiles',
    'ISpeechRecoResultDispatch', 'SpeechRecognitionType',
    'SGRSTTTextBuffer', 'DISPID_SVSLastBookmarkId',
    'DISPID_SGRsFindRule', 'SDTAll',
    'DISPID_SVSInputSentencePosition', 'SPFM_OPEN_READONLY',
    'SAFT32kHz16BitStereo', 'SpeechGrammarState',
    'SPWT_PRONUNCIATION', 'SSFMOpenReadWrite', 'SpeechAddRemoveWord',
    'SDTAudio', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRGDictationUnload', 'tagSPTEXTSELECTIONINFO',
    'SVESentenceBoundary', 'SpeechVoiceSkipTypeSentence',
    'SPINTERFERENCE_NONE', 'SPPS_LMA', 'SpeechRuleState', 'SITooFast',
    'SpMMAudioEnum', 'SpeechCategoryVoices', 'SPAUDIOOPTIONS',
    'STSF_FlagCreate', 'DISPID_SRCEEnginePrivate', 'SPSNotOverriden',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SMSALineId',
    'SDA_No_Trailing_Space', 'SECFDefault', 'SPPHRASEELEMENT',
    'DISPID_SGRSAddSpecialTransition', 'SpeechMicTraining',
    'SPBOOKMARKOPTIONS', 'DISPID_SRRAudio', 'SPPS_Noun',
    'DISPID_SpeechPhoneConverter', 'IInternetSecurityMgrSite',
    'SPADAPTATIONRELEVANCE', 'SRERecognition',
    ...
    'DISPID_SVSLastResult', 'DISPID_SLAddPronunciationByPhoneIds',
    'eLEXTYPE_PRIVATE8', 'SP_VISEME_20', 'SECFIgnoreKanaType',
    'SpeechVisemeFeature', 'SPEI_PHRASE_START',
    'DISPID_SLGenerationId', 'DISPID_SGRsCommit', 'SP_VISEME_13',
    'SVEAudioLevel', 'SVP_6', 'SVSFParseSsml', 'SPEI_MAX_SR',
    'DISPID_SpeechRecoResult2', 'DISPID_SRCEEndStream',
    'SDKLDefaultLocation', 'SRATopLevel', 'Speech_StreamPos_RealTime',
    'SPEVENTSOURCEINFO', 'SPVPRIORITY', 'STSF_LocalAppData',
    'SVF_Stressed', 'DISPID_SPRsItem', 'ISpXMLRecoResult',
    'DISPID_SADefaultFormat', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SABufferInfo', 'eLEXTYPE_RESERVED4',
    'SPRECOCONTEXTSTATUS', 'SBOPause', 'SP_VISEME_11',
    'SAFT12kHz8BitStereo', 'ISpeechRecognizerStatus',
    'DISPID_SOTRemove', 'SVSFUnusedFlags', 'DISPIDSPTSI_ActiveLength',
    'SpeechTokenIdUserLexicon', 'DISPID_SPAsItem',
    'DISPID_SRSetPropertyNumber', 'DISPID_SpeechGrammarRules',
    'ISpRecoGrammar', 'ISpeechMMSysAudio',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRAudioInput',
    'SpeechVoiceEvents', 'SpeechAudioVolume',
    'DISPID_SRCVoicePurgeEvent', 'SPPHRASE', 'ISpStream',
    'ISpRecoGrammar2', 'SPXRO_Alternates_SML', 'DISPID_SPRsCount',
    ...
    'ISpMMSysAudio', 'SRSInactiveWithPurge',
    'DISPID_SpeechLexiconWord', 'SpShortcut', 'DISPID_SGRAttributes',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpeechXMLRecoResult',
    'DISPID_SGRsCommitAndSave', 'ISpeechLexiconWord',
    'SpeechEngineProperties', 'ISpeechVoiceStatus',
    'ISpeechLexiconPronunciation', 'ISpEventSink', 'SPSHT_OTHER',
    'DISPID_SDKSetStringValue', 'SVEStartInputStream',
    'DISPID_SVSLastStreamNumberQueued', 'SpeechLoadOption',
    'DISPID_SRGCmdLoadFromResource', 'SGSExclusive',
    'DISPID_SRDisplayUI', 'SDKLCurrentConfig', 'SAFT48kHz8BitMono',
    'ISpSerializeState', 'SPRST_INACTIVE', 'SpMemoryStream',
    'DISPID_SVWaitUntilDone', 'SPEI_END_INPUT_STREAM', 'SP_VISEME_16',
    'eLEXTYPE_PRIVATE9', 'SPFM_CREATE',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SGRSAddWordTransition', 'SpeechStreamFileMode',
    'SAFT32kHz8BitStereo', 'DISPID_SOTs_NewEnum', 'SREHypothesis',
    'SRARoot', 'SVSFPersistXML', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRCAudioInInterferenceStatus', 'SpeechAllElements',
    'SVP_11', 'ISpPhraseAlt', 'DISPID_SLWPronunciations',
    'SGLexicalNoSpecialChars', 'DISPID_SOTCId', 'SPSEMANTICERRORINFO',
    ...
    'DISPID_SpeechLexicon', 'SpNotifyTranslator',
    'DISPID_SRCRetainedAudio', 'SpeechLexiconType',
    'SAFTADPCM_11kHzMono', 'DISPID_SRCEventInterests',
    'SPEI_TTS_AUDIO_LEVEL', 'SPSInterjection', 'SPCT_COMMAND',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPDKL_CurrentConfig',
    'DISPID_SLGetWords', 'SREAudioLevel',
    ...
    'SRSEIsSpeaking', 'SPAUDIOSTATUS', 'eWORDTYPE_DELETED',
    ...
    'DISPID_SPILanguageId', 'DISPID_SRCBookmark', 'SAFT32kHz8BitMono',
    'DISPID_SRCRequestedUIType', 'DISPID_SGRInitialState',
    ...
    'SPAS_STOP', 'SVP_3', 'DISPID_SVStatus', 'SPAUDIOBUFFERINFO',
    'DISPID_SVEStreamStart', 'SAFT44kHz8BitStereo',
    'DISPID_SpeechPhraseInfo', 'DISPID_SRGCmdLoadFromObject',
    'SPLO_DYNAMIC', 'DISPID_SBSWrite', 'DISPID_SPPsCount',
    'SAFT11kHz8BitStereo', 'SpeechDataKeyLocation', 'SPPHRASERULE',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SBSRead', 'SAFTDefault',
    'DISPID_SVVolume', 'SGRSTTWord', 'DISPID_SPRuleFirstElement',
    'SAFTADPCM_8kHzMono', 'DISPID_SRCEBookmark', 'SAFT8kHz16BitMono',
    'SVP_9', 'SLTApp', 'DISPID_SPIGrammarId',
    ...
    'eLEXTYPE_PRIVATE13', 'SAFT16kHz16BitStereo', 'ISpNotifySink',
    'ISpeechPhraseAlternates', 'SPEI_FALSE_RECOGNITION',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SGRSTs_NewEnum',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SGRId', 'DISPID_SPRs_NewEnum',
    'LONG_PTR', 'SPBO_AHEAD', 'ISpeechDataKey', 'SDTRule',
    'SINoSignal', 'SPSMF_SRGS_SAPIPROPERTIES', 'SpeechTokenContext',
    'SGPronounciation', 'SPPS_Interjection', 'SPLEXICONTYPE',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SABIEventBias',
    'DISPID_SRCESoundStart', 'DISPID_SVGetAudioOutputs', 'SRSEDone',
    ...
    'SVF_None', 'SRTAutopause', 'SECLowConfidence', 'SRAONone',
    'SPSFunction', 'eLEXTYPE_PRIVATE19', 'SPAR_Unknown',
    'DISPID_SVGetProfiles', 'SAFTADPCM_8kHzStereo', 'SPPROPERTYINFO',
    'eLEXTYPE_RESERVED9', 'SpMMAudioOut', 'SPEI_RESERVED6',
    'DISPID_SRSCurrentStreamPosition', 'SITooLoud', 'SGRSTTWildcard',
    'SPGS_EXCLUSIVE', 'SPEI_HYPOTHESIS', 'SPEI_RESERVED1',
    'SpeechFormatType', 'SVEEndInputStream', 'SPEI_RESERVED3',
    'SPWT_LEXICAL', 'SpeechTokenShellFolder', 'ISpRecognizer3',
    'SPGRAMMARSTATE', 'DISPID_SOTId', 'STSF_AppData',
    'SpeechCategoryAppLexicons', 'ISpObjectWithToken',
    'DISPID_SRRAudioFormat', 'STSF_CommonAppData',
    'SDA_One_Trailing_Space', 'DISPID_SRGSetWordSequenceData',
    'ISpRecoContext2', 'SGSDisabled', 'DISPID_SpeechRecoResult',
    'Speech_Max_Word_Length', 'DISPID_SVSyncronousSpeakTimeout',
    'SPSUnknown', 'DISPID_SWFEFormatTag', 'DISPID_SPPFirstElement',
    'DISPID_SGRSTRule', 'DISPID_SOTsCount', 'SPCATEGORYTYPE',
    'SPEI_PHONEME', 'SpeechRegistryUserRoot', 'ISpPhoneConverter',
    ...
    'SRERequestUI', 'ISpeechRecoResult', 'ISpNotifyTranslator',
    'SPPHRASEPROPERTY', 'SAFTADPCM_22kHzStereo',
    'DISPID_SOTMatchesAttributes', 'DISPID_SPPId',
    'SpSharedRecognizer', 'SPWORDTYPE', 'DISPID_SGRsDynamic',
    'SpAudioFormat', 'DISPID_SPRDisplayAttributes', 'SVSFVoiceMask',
    'DISPID_SRCEStartStream', 'SAFTGSM610_44kHzMono',
    'SPSERIALIZEDRESULT', 'SAFTNoAssignedFormat', 'DISPID_SVEViseme',
    'DISPID_SMSSetData', 'DISPID_SVRate', 'DISPID_SVSRunningState',
    'DISPID_SRStatus', 'ISpeechCustomStream', 'DISPID_SDKOpenKey',
    'SpVoice', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRRGetXMLErrorInfo', 'STCRemoteServer', 'SGDisplay',
    'ISpeechPhraseAlternate', 'SGRSTTDictation', 'ISpeechRecoGrammar',
    'SP_VISEME_5', 'SpeechRecoProfileProperties', 'DISPID_SPIRule',
    'DISPID_SPPValue', 'SVP_0', 'DISPID_SPACommit', 'SPXRO_SML',
    'DISPID_SPEEngineConfidence', 'SRTExtendableParse', 'SRTReSent',
    'SRSActive', 'SDTReplacement', 'SpTextSelectionInformation',
    'DISPID_SPEDisplayText', 'DISPID_SpeechVoiceStatus',
    'SPEI_END_SR_STREAM', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPWAVEFORMATTYPE', 'SPTEXTSELECTIONINFO',
    'ISpeechAudioBufferInfo', 'DISPID_SPPParent', 'SPCT_DICTATION',
    'SAFTCCITT_uLaw_8kHzStereo', 'SLTUser',
    'DISPID_SLGetGenerationChange', 'eLEXTYPE_PRIVATE3',
    'SpMMAudioIn', 'DISPID_SRGState', 'SP_VISEME_6', 'SVEPrivate',
    'SP_VISEME_18', 'SASRun', 'DISPID_SGRSTsCount',
    'ISpObjectTokenCategory', 'DISPID_SpeechObjectTokens',
    'DISPID_SRCEFalseRecognition', 'SVP_8', 'DISPID_SPPChildren',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPRST_NUM_STATES',
    'SPAO_RETAIN_AUDIO', 'SAFT24kHz8BitMono', 'SpInProcRecoContext',
    ...
    'SPCS_ENABLED', 'SBONone', 'SREFalseRecognition',
    'eLEXTYPE_RESERVED10', 'SP_VISEME_12', 'SAFT22kHz16BitStereo',
    'SpeechRetainedAudioOptions', 'DISPID_SLPsCount',
    'DISPID_SWFEBlockAlign', 'SAFTADPCM_22kHzMono', 'SDKLCurrentUser',
    'SVPNormal', 'DISPID_SOTRemoveStorageFileName', 'SP_VISEME_1',
    'SRTEmulated', 'SAFT11kHz16BitStereo', 'SAFT22kHz8BitMono',
    'SPDKL_LocalMachine', 'DISPID_SPAStartElementInResult',
    'DISPID_SPERequiredConfidence', 'DISPID_SMSADeviceId',
    'DISPID_SPISaveToMemory', 'SAFTADPCM_11kHzStereo', 'SVP_2',
    'SPAUDIOSTATE', 'SLODynamic', 'SPEI_REQUEST_UI', 'SVEVoiceChange',
    'ISpeechObjectTokenCategory', 'DISPID_SWFEExtraData', 'SVP_19',
    ...
    'SAFTText', 'DISPID_SVVoice', 'DISPIDSPRG', 'SRADefaultToActive',
    'DISPID_SRRTStreamTime', 'DISPID_SRRDiscardResultInfo',
    'SASPause', 'SpeechEngineConfidence', 'DISPID_SRAudioInputStream',
    'SPBINARYGRAMMAR', 'SAFT44kHz16BitMono', 'SpResourceManager',
    'SAFT8kHz8BitMono', 'SAFTCCITT_uLaw_44kHzStereo', 'SWTDeleted',
    'DISPID_SGRSTText', 'ISpeechResourceLoader',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRGetPropertyString',
    'DISPID_SRState', 'DISPID_SBSFormat', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SAEventHandle', 'SREStreamEnd', 'SPEVENT',
    'DISPID_SAStatus', 'SPVPRI_OVER', 'DISPID_SPRuleName',
    ...
    'DISPID_SPPConfidence', 'eLEXTYPE_LETTERTOSOUND', 'SVP_4',
    'SSFMOpenForRead', 'SPEI_TTS_PRIVATE', 'SPAS_PAUSE',
    'SPDATAKEYLOCATION', 'eLEXTYPE_RESERVED7',
    'SPEI_RECO_OTHER_CONTEXT', 'SVP_18', 'SFTInput',
    'IInternetSecurityManager', 'DISPID_SRRTimes', 'SpPhoneConverter',
    'DISPID_SASNonBlockingIO', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SVEEnginePrivate', 'SPEI_SOUND_END',
    'DISPID_SVEventInterests', 'DISPID_SOTDataKey',
    'SpPhoneticAlphabetConverter', 'DISPID_SAFSetWaveFormatEx',
    'SPCT_SUB_DICTATION', 'ISpLexicon', 'DISPID_SRRTOffsetFromStart',
    ...
    'DISPID_SRCreateRecoContext', 'DISPID_SAFGuid',
    'DISPID_SRRAlternates', 'SPCT_SLEEP', 'DISPID_SpeechMemoryStream',
    'DISPID_SGRs_NewEnum', 'ISpRecognizer2', 'ISpPhrase',
    'DISPID_SpeechRecoContext', 'SREAdaptation', 'SVP_10',
    'SPEI_RESERVED5', 'DISPID_SPRuleParent', 'SRAORetainAudio',
    'DISPID_SRGDictationLoad', 'SPEI_VISEME',
    'Speech_Max_Pron_Length', 'DISPIDSPTSI_ActiveOffset',
    'SPGRAMMARWORDTYPE', 'SAFT11kHz8BitMono', 'SP_VISEME_21',
    'SPEI_INTERFERENCE', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'ISpeechObjectTokens', 'SpCompressedLexicon', 'SpeechRunState',
    'eWORDTYPE_ADDED', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SRADynamic', 'DISPID_SRSClsidEngine', 'SVP_1', 'SPSLMA',
    'SAFT48kHz16BitStereo', 'SDKLLocalMachine', 'SECFNoSpecialChars',
    'SVP_21', 'ISpeechGrammarRuleState', 'DISPID_SRGetRecognizers',
    'DISPID_SPRules_NewEnum', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SPRuleConfidence', 'DISPID_SpeechGrammarRule',
    'DISPID_SVAlertBoundary', 'DISPID_SRCEHypothesis',
    'DISPID_SMSAMMHandle', 'DISPID_SRGCmdSetRuleIdState',
    'SpeechPropertyComplexResponseSpeed', 'eLEXTYPE_RESERVED6',
    'DISPID_SGRAddState', 'IStream', 'DISPID_SOTDisplayUI',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRCSetAdaptationData',
    'SVEAllEvents', 'DISPID_SAFType', 'DISPID_SVEStreamEnd',
    'SRAInterpreter', 'DISPID_SGRSTType', 'SPWF_SRENGINE',
    'DISPID_SOTCSetId', 'ISpeechLexicon', 'SPEVENTENUM',
    'DISPID_SRGCommit', 'DISPID_SVEPhoneme', 'SPLOADOPTIONS',
    'SPAR_High', 'SAFTCCITT_uLaw_22kHzStereo', 'SP_VISEME_17',
    'DISPID_SRGRecoContext', 'DISPID_SWFEBitsPerSample', 'SLOStatic',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpeechGrammarRules',
    'SAFT12kHz8BitMono', 'ISpeechPhraseElements',
    'DISPID_SpeechPhraseRules', 'DISPID_SRGReset',
    'ISpeechAudioStatus', 'SpeechVoicePriority', 'SVSFNLPSpeakPunc',
    'SPWORDLIST', 'DISPID_SFSOpen', 'SGRSTTRule',
    'ISpeechRecoResultTimes', 'SDA_Two_Trailing_Spaces',
    'SECHighConfidence', 'eLEXTYPE_PRIVATE5',
    ...
    'SPWORD', 'DISPID_SOTCGetDataKey', 'DISPID_SRIsUISupported',
    'SpeechPropertyAdaptationOn', 'DISPID_SpeechLexiconWords',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpeechPhraseReplacements',
    'ISpNotifySource', 'DISPID_SLPLangId', 'SSSPTRelativeToStart',
    'SRESoundEnd', 'eLEXTYPE_PRIVATE1', 'DISPID_SpeechPhraseRule',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SP_VISEME_9', 'SPEI_MIN_TTS',
    'SPWF_INPUT', 'DISPID_SPIProperties', 'SRERecoOtherContext',
    'eLEXTYPE_PRIVATE16', 'DISPID_SLPPhoneIds', 'SpSharedRecoContext',
    'DISPID_SPRText', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SOTGetAttribute',
    'SpObjectToken', 'SVSFNLPMask', 'SVP_16', 'DISPID_SVAudioOutput',
    'SAFT16kHz16BitMono', 'eLEXTYPE_PRIVATE20',
    'DISPID_SpeechDataKey', 'ISpeechPhoneConverter',
    'DISPID_SVEAudioLevel', 'ISpeechAudio', 'eLEXTYPE_USER_SHORTCUT',
    'SAFTADPCM_44kHzMono', 'SDTAlternates',
    'DISPID_SpeechPhraseElements', 'SpeechAudioFormatType',
    'DISPID_SPRFirstElement', 'SpeechWordPronounceable', 'SPPS_Verb',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SVSLastBookmark',
    'SPRST_ACTIVE_ALWAYS', 'SPINTERFERENCE_NOSIGNAL',
    'eLEXTYPE_PRIVATE4', 'SSSPTRelativeToEnd',
    'SPDKL_DefaultLocation', 'SAFT24kHz8BitStereo', 'ISpObjectToken',
    'SREPrivate', 'SpInprocRecognizer', 'SPINTERFERENCE_TOOFAST',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpStreamFormatConverter',
    'DISPID_SVEWord', 'STCInprocHandler', 'SP_VISEME_2',
    'SPGS_ENABLED', '__MIDL_IWinTypes_0009', 'ISpAudio',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SAVolume',
    'DISPID_SRCResume', 'SAFT32kHz16BitMono', '_SPAUDIOSTATE',
    'SPSHT_Unknown', 'SPBO_TIME_UNITS', 'SPSModifier', 'SVPAlert',
    ...
    'SAFTGSM610_11kHzMono', 'SGRSTTEpsilon', 'SPINTERFERENCE',
    'DISPID_SPRNumberOfElements', 'DISPID_SVAudioOutputStream',
    'SpeechRecognizerState', 'DISPID_SGRSTPropertyId', 'SPSHT_EMAIL',
    'SPRULESTATE', 'SAFT11kHz16BitMono', 'DISPID_SRCVoice',
    'DISPID_SRCCmdMaxAlternates', 'SVP_13', 'SSFMCreateForWrite',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SpeechObjectToken',
    'SPAS_CLOSED', 'SAFTCCITT_uLaw_8kHzMono', 'SpeechRecoEvents',
    'SAFT24kHz16BitMono', 'SGDSActive', 'SVSFIsXML',
    'ISpeechPhraseProperty', 'eLEXTYPE_PRIVATE14',
    'DISPID_SPEAudioSizeBytes', 'SpFileStream', 'SAFT44kHz8BitMono',
    'SSTTDictation', 'SpLexicon', 'DISPID_SGRsItem',
    'DISPID_SWFESamplesPerSec', 'SWPUnknownWordUnpronounceable',
    'DISPID_SLAddPronunciation', 'SPEI_SR_BOOKMARK', 'STCAll',
    'SPEI_SR_PRIVATE', 'SpWaveFormatEx', 'ISpeechPhraseElement',
    'DISPID_SpeechVoice', 'DISPID_SRRTLength', 'SGDSInactive',
    'DISPID_SpeechPhraseAlternate', 'SpeechPropertyResourceUsage',
    'DISPID_SpeechRecoContextEvents', 'ISpResourceManager',
    'SAFT22kHz16BitMono', 'eLEXTYPE_PRIVATE6', 'SWTAdded',
    'DISPID_SVSVisemeId', 'SPDKL_CurrentUser', 'SPPS_RESERVED2',
    'ISpRecoContext', 'SpeechUserTraining', 'SpeechDiscardType',
    'SECFEmulateResult', 'SRCS_Enabled', 'SPSHORTCUTPAIRLIST',
    'SVEViseme', 'SPAR_Medium', 'DISPID_SRProfile',
    'SPSTREAMFORMATTYPE', 'SpeechTokenKeyAttributes',
    'DISPID_SVSpeakStream', 'DISPID_SVDisplayUI',
    'DISPID_SVSPhonemeId', 'DISPID_SLWs_NewEnum', 'SpCustomStream',
    'DISPID_SOTIsUISupported', 'SPSVerb', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SPPsItem', 'ISpStreamFormat', 'DISPIDSPTSI',
    'ISpRecoResult', 'SAFT22kHz8BitStereo', 'SPPS_Unknown',
    'DISPID_SPCPhoneToId', 'DISPID_SRGCmdLoadFromFile',
    '_RemotableHandle', 'SPPS_RESERVED3', 'SAFTADPCM_44kHzStereo',
    'ISpeechPhraseRules', 'DISPID_SGRSAddRuleTransition',
    'SSTTTextBuffer', 'SPSSuppressWord', 'SPEI_TTS_BOOKMARK',
    'SREPropertyStringChange', 'SPEI_MAX_TTS', 'SVP_20',
    'SPEI_PROPERTY_STRING_CHANGE', 'eLEXTYPE_PRIVATE15',
    'DISPID_SPPName', 'DISPID_SRCState', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPAR_Low', 'SPRS_INACTIVE', 'DISPID_SLRemovePronunciation',
    'DISPID_SLGetPronunciations', 'SpeechDisplayAttributes',
    'SDTLexicalForm', 'DISPID_SPCIdToPhone',
    'DISPID_SRCERecognizerStateChange', 'SpeechCategoryAudioOut',
    'SPPS_Modifier', 'DISPID_SPAsCount',
    'SWPUnknownWordPronounceable', 'SPVISEMES',
    'DISPID_SPERetainedStreamOffset', 'SpeechTokenKeyUI',
    'DISPID_SPIGetText', 'eLEXTYPE_PRIVATE18', 'DISPID_SMSGetData',
    'ISpeechVoice', 'DISPID_SDKSetLongValue',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpeechGrammarRuleStateTransitions',
    'SPAS_RUN', 'SAFT12kHz16BitStereo', 'SPSHT_NotOverriden',
    'ISpeechRecoContext', 'DISPID_SPRuleChildren', 'SPBO_NONE',
    'DISPID_SRGIsPronounceable', 'DISPID_SPPs_NewEnum',
    'SPEI_UNDEFINED', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SRRSaveToMemory', 'ISpeechPhraseInfo', 'SRTStandard',
    'DISPID_SVEVoiceChange', 'DISPID_SOTCreateInstance',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SRGRules', 'SVSFlagsAsync',
    'DISPID_SRCEPhraseStart', 'DISPID_SDKDeleteValue',
    'DISPID_SRRPhraseInfo', 'SpNullPhoneConverter',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SABIBufferSize',
    'DISPID_SRGetFormat', 'DISPID_SVSInputWordLength',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPRST_ACTIVE', 'SRTSMLTimeout',
    'DISPID_SVIsUISupported', 'SAFTGSM610_8kHzMono',
    'SECNormalConfidence', 'SPSNoun', 'SPPS_RESERVED1',
    'ISpeechGrammarRule', 'DISPID_SDKSetBinaryValue',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SOTSetId',
    'DISPID_SRRSetTextFeedback', 'DISPID_SDKEnumKeys', 'SPLO_STATIC',
    'SAFTCCITT_ALaw_8kHzMono', 'SECFIgnoreWidth', 'ISpShortcut',
    'DISPID_SGRsAdd', 'SpeechAudioFormatGUIDText',
    'SWPKnownWordPronounceable', 'ISpeechAudioFormat', 'SP_VISEME_3',
    'ISpEventSource', 'SPEI_RECOGNITION', 'SVSFParseMask',
    'DISPID_SDKGetBinaryValue', 'SPEI_MIN_SR', 'DISPID_SDKEnumValues',
    'SREBookmark', 'SpeechRuleAttributes', 'ISpeechRecoResult2',
    'SPINTERFERENCE_TOOSLOW', 'SREInterference',
    '_ISpeechRecoContextEvents', 'DISPID_SRCEPropertyStringChange',
    'ISpDataKey', 'ISpeechFileStream', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SPFILEMODE',
    'SPXMLRESULTOPTIONS', 'DISPID_SRCEAdaptation',
    'eLEXTYPE_PRIVATE10', 'SPWT_DISPLAY', 'SAFT16kHz8BitMono',
    'SAFT48kHz8BitStereo', 'DISPID_SPIEngineId',
    'DISPID_SGRSTransitions', 'SPRS_ACTIVE', 'SVF_Emphasis',
    '_ISpeechVoiceEvents', 'DISPID_SGRSTPropertyValue',
    'eLEXTYPE_PRIVATE7', 'DISPID_SGRSTWeight', 'SVSFIsFilename',
    'DISPID_SFSClose', 'ISpeechLexiconPronunciations',
    'DISPID_SPEActualConfidence', 'SVP_14', 'DISPID_SRGId',
    'SPFM_CREATE_ALWAYS', 'DISPID_SpeechRecognizer',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRCESoundEnd',
    'IEnumString', 'DISPID_SDKGetlongValue', 'DISPID_SBSSeek',
    'DISPID_SpeechCustomStream', 'DISPID_SASFreeBufferSpace',
    'SPWORDPRONUNCIATION', 'DISPID_SVResume', 'DISPID_SLPs_NewEnum',
    'DISPID_SGRsCount', 'DISPID_SPEsItem', 'DISPID_SVGetVoices',
    'SPFM_OPEN_READWRITE', 'SPVPRI_ALERT', 'SP_VISEME_10',
    'DISPID_SpeechPhraseBuilder', 'SPVPRI_NORMAL',
    'DISPID_SPELexicalForm', 'DISPID_SRCERequestUI',
    'SPEI_START_INPUT_STREAM', 'SAFT16kHz8BitStereo',
    'DISPID_SGRSTsItem', 'SFTSREngine', 'SPPS_Function',
    'SpeechAudioProperties', 'STCInprocServer', 'DISPID_SASetState',
    'ISpRecoCategory', 'DISPID_SVSpeak', 'SREPropertyNumChange',
    'SAFT24kHz16BitStereo', 'SGSEnabled', 'SP_VISEME_0',
    'SP_VISEME_19', 'DISPID_SPEs_NewEnum', 'SASStop',
    'SECFIgnoreCase', 'tagSTATSTG', 'SPPARTOFSPEECH', 'SPCS_DISABLED',
    'SPAO_NONE', 'DISPID_SPEAudioTimeOffset', 'DISPID_SPCLangId',
    'SGDSActiveUserDelimited', 'DISPID_SPRulesItem',
    'SpeechCategoryRecognizers', 'DISPID_SRRSpeakAudio',
    'SPINTERFERENCE_LATENCY_WARNING', 'SINoise', 'SINone',
    'DISPID_SPPNumberOfElements'
]

_check_version('1.1.14', 1651900789.649301)
